    ...
    return (
        <div className='flex items-center flex-col pb-10 bg-gradient-to-b from-[#4f0606] to-black'>
            <div className='p-5 mt-14 rounded-2xl border-2 border-red-900 w-[80%] text-white bg-zinc-900 '>
                ...
                e não todos! Saiba mais sobre os principais membros da Night Raider e suas particularidades 
                e saiba mais sobrea a principal Vilã da obra!
            </div>
            <div className='flex justify-between w-screen items-center p-[4rem] py-10'>
                ...
                <div ref={CarrosselRef} className='flex transition-all relative overflow-hidden w-[1074px] h-[330px] '>
                    {/* Tatsumi */}
                    <div className='flex w-[1074px] h-[330px]'>
                        <div className='h-[330px] w-[300px]'>
                            <figure className='relative h-full w-full'>
                                <Image className='object-cover rounded-tl-lg rounded-bl-lg' src={Tatsumi} fill={true} />
                            </figure>
                        </div>
                        <div className='text-white w-[49rem] bg-stone-900 rounded-tr-lg rounded-br-lg'>
                            <h1 className='text-center font-semibold text-lg p-2 border-b-2 border-red-800 rounded-tr-lg bg-zinc-800'>Tatsumi</h1>
                            <p className='p-4 font-medium text-lg text-justify'>
                    ...
                    <div className='flex w-[1074px]  h-[330px]'>
                        ...
                        <div className='text-white w-[49rem] bg-stone-900 rounded-tr-lg rounded-br-lg'>
                            <h1 className='text-center font-semibold text-lg p-2 border-b-2 border-red-800 rounded-tr-lg bg-zinc-800'>Akame</h1>
                            <p className='p-4 text-lg font-medium text-justify'>
                    ...
                    <div className='flex w-[1074px]  h-[330px]'>
                        ...
                        <div className='text-white w-[49rem] bg-stone-900 rounded-tr-lg rounded-br-lg'>
                            <h1 className='text-center font-semibold text-lg p-2 border-b-2 border-red-800 rounded-tr-lg bg-zinc-800'>Bulat</h1>
                            <p className='p-4 text-lg font-medium text-justify'>
                    ...
                    <div className='flex w-[1074px]  h-[330px]'>
                        ...
                        <div className='text-white w-[49rem] bg-stone-900 rounded-tr-lg rounded-br-lg'>
                            <h1 className='text-center font-semibold text-lg p-2 border-b-2 border-red-800 rounded-tr-lg bg-zinc-800'>Chelsea</h1>
                            <p className='p-4 text-lg font-medium text-justify'>
                    ...
                    <div className='flex w-[1074px] h-[330px]'>
                        ...
                        <div className='text-white w-[49rem] bg-stone-900 rounded-tr-lg rounded-br-lg'>
                            <h1 className='text-center font-semibold text-lg p-2 border-b-2 border-red-800 rounded-tr-lg bg-zinc-800'>Esdeath</h1>
                            <p className='p-4 text-lg font-medium text-justify'>
                    ...
                    <div className='flex w-[1074px]  h-[330px]'>
                        ...
                        <div className='text-white w-[49rem] bg-stone-900 rounded-tr-lg rounded-br-lg'>
                            <h1 className='text-center font-semibold text-lg p-2 border-b-2 border-red-800 rounded-tr-lg bg-zinc-800'>Leone</h1>
                            <p className='p-4 text-lg font-medium text-justify'>
                    ...
                    <div className='flex w-[1074px] h-[330px]'>
                        ...
                        <div className='text-white w-[49rem] bg-stone-900 rounded-tr-lg rounded-br-lg'>
                            <h1 className='text-center font-semibold text-lg p-2 border-b-2 border-red-800 rounded-tr-lg bg-zinc-800'>Lubbock</h1>
                            <p className='p-4 text-lg font-medium text-justify'>
                    ...
                    <div className='flex w-[1074px]  h-[330px]'>
                        ...
                        <div className='text-white w-[49rem] bg-stone-900 rounded-tr-lg rounded-br-lg'>
                            <h1 className='text-center font-semibold text-lg p-2 border-b-2 border-red-800 rounded-tr-lg bg-zinc-800'>Shelly</h1>
                            <p className='p-4 text-lg font-medium text-justify'>
                    ...
                    <div className='flex w-[1074px] h-[330px]'>
                        ...
                        <div className='text-white w-[49rem] bg-stone-900 rounded-tr-lg rounded-br-lg'>
                            <h1 className='text-center font-semibold text-lg p-2 border-b-2 border-red-800 rounded-tr-lg bg-zinc-800'>Mine</h1>
                            <p className='p-4 text-lg font-medium text-justify'>
                    ...
                    <div className='flex w-[1074px]  h-[330px]'>
                        ...
                        <div className='text-white w-[49rem] bg-stone-900 rounded-tr-lg rounded-br-lg'>
                            <h1 className='text-center font-semibold text-lg p-2 border-b-2 border-red-800 rounded-tr-lg bg-zinc-800'>Najenda</h1>
                            <p className='p-4 text-lg font-medium text-justify'>
